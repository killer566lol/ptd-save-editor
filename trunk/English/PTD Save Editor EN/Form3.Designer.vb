...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        Me.lb_Events.Items.AddRange(New Object() {"Make Starter Shiny", "Get a Shiny Bulbasaur", "Get a Shiny Charmander", "Get a Shiny Squirtle", "Get a Shiny Mew", "Get a Shiny Pikachu", "Get a Shiny Pidgey", "Get a Shiny Geodude", "Get a Shiny Jigglypuff"})
