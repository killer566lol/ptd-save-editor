...
Partial Class Form3_Evts
    ...
    Private Sub InitializeComponent()
        ...
        Me.lb_Events.Items.AddRange(New Object() {"Rendre le Starter Shiny", "Obtenir un Bulbizarre Shiny", "Obtenir un Salamèche Shiny", "Obtenir un Carapuce Shiny", "Obtenir le Mew Shiny", "Obtenir le Pikachu Shiny", "Obtenir le Roucool Shiny", "Obtenir le Racaillou Shiny", "Obtenir le Rondoudou Shiny", "Obtenir le Rattata Shiny", "Obtenir Lippoutou", "Obtenir le Nosferapti Shiny", "Obtenir le Abra Shiny", "Obtenir le Salamèche Shiny", "Obtenir le Piafabec Shiny", "Obtenir le Magicarpe Shiny", "Obtenir Canarticho", "Obtenir le Onix Normal", "Obtenir le Onix Shiny", "Obtenir le Stari Normal", "Obtenir le Stari Shiny"})
